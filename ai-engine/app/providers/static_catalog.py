...
class StaticPlaceProvider:
    """Deterministic baseline provider backed by the public seed catalog."""

    def list_places(self) -> list[dict]:
        return enriched_travel_places()


_DEFAULT_PLACE_PROVIDER = StaticPlaceProvider()


def get_default_place_provider() -> PlaceProvider:
    return _DEFAULT_PLACE_PROVIDER
