...
| Week 5 | Recommendation Engine | Recommendation Ranking Engine v2, configurable profiles, group satisfaction scoring, recommendation explanations, retrieval-to-ranking flow |
